...
# predict the input
def input_predict(image, parameters):
    """
    This function is used to predict the results of a  L-layer neural network.
    ...
    # Forward propagation
    prob, caches = L_model_forward(image, parameters)
    y_pred = ""
...
parameters, costs = L_layer_model(train_x, y_train, layers_dims, learning_rate=0.0075, num_iterations=2500, print_cost=False)
# pred_train = predict(train_x, y_train, parameters)

# input_predict(image, parameters)
